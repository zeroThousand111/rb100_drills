...
# Link the empty hashes in the contacts hash with the contact_data array
# This time I used the first and last methods combined with index numbers of the array
